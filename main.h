...
int _print_hexUpper(va_list args, int flags, int width, int precision, int size);
...
int printhandler(va_list args, const char *format, int i, int flags, int width, int precision, int size);
void print_buffer(char buffer[], int *buff_ind);
int _nonprinthandler(va_list args, int flags, int width, int precision, int size);
